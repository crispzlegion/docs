...
2. Check out our other quick starts to see how to build with other networks integrating into FairyRing in [Start a cApp](/build/start-a-capp).
...
Ensure you have installed the [`fairyring` binary](/protocol/node/installation) before following the instructions below.
