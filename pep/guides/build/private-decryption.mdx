...
For more cApp ideas make sure to check out our [community resources](/resources/community).
...
1. Check out our other quick starts to see how to build with other networks integrating into FairyRing in [Start a cApp](/build/start-a-capp).
