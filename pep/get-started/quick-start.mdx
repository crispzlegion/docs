...
The following page will run you through creating a Confidential App, or cApp, unlocking confidential computation using Fairblock's decentralized blockchain, FairyRing. cApps take the form of an App on a network like FairyRing, an EVM, or even as another independent chain itself.
...
Developers looking to build with FairyRing, either natively or within another chain, are encouraged to reference the respective tutorials in the [build guides](/pep/guides/build/encrypted-transactions).
