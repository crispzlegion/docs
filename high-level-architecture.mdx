...
<CardGroup cols={2}>
  <Card title="Confidential Transfers →" href="/ct/overview">
    Encrypted amounts and balances on public blockchains.
  </Card>
  <Card title="Pre-Execution Privacy →" href="/pep/overview">
    Sealed-bid auctions, private governance, and encrypted transactions.
  </Card>
</CardGroup>
