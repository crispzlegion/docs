...
### Encryption SDK
Off-chain software used to encrypt transactions before submitting them to the destination chain.
...
### FairyPort
Off-chain messaging bridge for key distribution and cross-chain communication.
